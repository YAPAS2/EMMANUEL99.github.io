const CACHE_VERSION = '1.7.40.2';

const BASE_CACHE_FILES = [
    'https://yapas2.local/wp-content/plugins/pwa-for-wp/images/logo.png',
'https://yapas2.local/wp-content/plugins/pwa-for-wp/images/logo-512x512.png',

];

const OFFLINE_CACHE_FILES = [
     'https://yapas2.local/?amp=1',
];
...
const OFFLINE_PAGE = 'https://yapas2.local/?amp=1';
const NOT_FOUND_PAGE = 'https://yapas2.local/?amp=1';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://yapas2.local//wp-admin/');
//    },
];
